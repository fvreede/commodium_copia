    ...
    <AuthenticatedLayout>
        ...
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <SecondaryButton @click="$inertia.visit(`/orders/${order.id}`)">
        ...
        <div class="py-12">
            <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center">
                                <div :class="[
                                    ...
                                    <component :is="getStatusIcon(order.status)" class="w-6 h-6" />
                                </div>
                                <div>
                            ...
                            <div v-if="deliverySlot" class="text-right">
                                <p class="text-sm text-gray-600">Geschatte bezorging</p>
                                <p class="font-semibold text-gray-900">{{ order.estimated_delivery }}</p>
                            </div>
                        </div>
                ...
                <div v-if="deliverySlot" class="mt-8 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="flex items-center p-4 bg-blue-50 rounded-lg border border-blue-200">
                                <CalendarDaysIcon class="w-8 h-8 text-blue-600 mr-4" />
                                <div>
                                    <p class="font-semibold text-blue-900">{{ deliverySlot.formatted_date }}</p>
                                    <p class="text-sm text-blue-700">Bezorgdatum</p>
                                </div>
                            </div>
                            
                            <div class="flex items-center p-4 bg-green-50 rounded-lg border border-green-200">
                                <ClockIcon class="w-8 h-8 text-green-600 mr-4" />
                                <div>
                                    <p class="font-semibold text-green-900">{{ deliverySlot.formatted_time }}</p>
                                    <p class="text-sm text-green-700">Tijdslot</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                    <SecondaryButton @click="refreshTracking" :disabled="refreshing">
